...
public class Enemy3 : MonoBehaviour // Speed Burst
{
    ...
    void Update()
    {
        ...
        if (Time.time > _enemyCanFire && _stopUpdating == false)
        {
            ...
            GameObject enemyLaser = Instantiate(_enemyDoubleShotLaserPrefab, new Vector3(transform.position.x, transform.position.y + 0.655f, transform.position.z), Quaternion.identity);
